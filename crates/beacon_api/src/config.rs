...
use silver_beacon_state_data::{
    ...
    EPOCHS_PER_SLASHINGS_VECTOR, FAR_FUTURE_EPOCH, Fork, ForkName, HISTORICAL_ROOTS_LIMIT,
    MAX_EXTRA_DATA_BYTES, MIN_SEED_LOOKAHEAD, PENDING_CONSOLIDATIONS_LIMIT, PENDING_DEPOSITS_LIMIT,
    PENDING_PARTIAL_WITHDRAWALS_LIMIT, SLOTS_PER_EPOCH, SLOTS_PER_HISTORICAL_ROOT,
    SYNC_COMMITTEE_SIZE, SpecConfig, VALIDATOR_REGISTRY_LIMIT,
};
use silver_common::{
