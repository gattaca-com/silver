...
use silver_beacon_state_data::{
    ...
    SYNC_COMMITTEE_SIZE, SpecConfig, StateDeltaView,
};
...
mod tests {
    ...
    use silver_beacon_state_data::{
        B256, DeltaBuffer, EPOCHS_RING_N, EpochStateDelta, Finalized, LONGTAILS_RING_N,
        LongtailState, PendingDeposit, SlotState, SlotStateDelta, StateDelta, StateDeltaView,
        ValSeed, ValidatorsDelta, Withdrawals,
    };
