...
use silver_beacon_state_data::{
    self as common, B256, BalancesWriteView, ColumnSpec, EPOCHS_PER_SLASHINGS_VECTOR, Epoch,
    ...
    ParticipationWriteView, PendingView, PendingWriteView, SLOTS_PER_EPOCH, SYNC_COMMITTEE_SIZE,
    Slot, SlotStateView, SlotStateWriteView, SpecConfig, StateId, StateReadView, StateWriterView,
