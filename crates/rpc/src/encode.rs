...
pub fn encode_ping(producer: &mut TProducer, seq: u64) -> Result<TCacheRead, Error> {
...
pub fn encode_goodbye(producer: &mut TProducer, reason: u64) -> Result<TCacheRead, Error> {
...
pub fn encode_blocks_by_range_request(
    producer: &mut TProducer,
    start_slot: u64,
    count: u64,
    step: u64,
...
pub fn encode_blocks_by_root_request(
    producer: &mut TProducer,
    roots: &[[u8; 32]],
) -> Result<TCacheRead, Error> {
...
#[inline]
fn encode_u64(producer: &mut TProducer, value: u64, size: usize) -> Result<TCacheRead, Error> {
